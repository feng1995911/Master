...
namespace StarForce
{
    public static class EntityExtension
    {
        ...
        public static void ShowHexBlock(this EntityComponent entityComponent, HexBlockData data)
        {
            if (data == null)
            {
            ...
            entityComponent.ShowEntity(data.Id, typeof(HexBlock), AssetUtility.GetMapBlockAsset(drEntity.AssetName), "HexBlock", Constant.AssetPriority.HexBlockAsset, data);
        }
